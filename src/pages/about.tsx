...
const About = () => {
  return (
    <>
      <Head>
        <title>About Us | LUMIO</title>
        <meta name="description" content="Discover a wide range of premium products at LUMIO. From electronics to lifestyle essentials, shop high-quality items at the best prices with a seamless shopping experience." />
        <meta property="og:title" content="About Us | LUMIO" />
        <meta property="og:description" content="Explore LUMIO's collection of top-quality products. Find electronics, fashion, accessories, and more with unbeatable deals and fast delivery." />
      </Head>
